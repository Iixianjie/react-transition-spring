...
const TransitionBase = ({ toggle, from, to, children, tag, appear, config, delay, mountOnEnter, unmountOnExit, changeVisible, style, interpolater, onStart, onRest, ...props }) => {
    const self = useSelf({
        toggle,
        count: 0,
    });
    ...
    return ((mount)
        ? (React.createElement(AnimatedEl, Object.assign({}, props, { style: { ...style, ...springProps, ...visibleStyle } }), typeof children === 'function' ? children(springProps) : children))
        : null);
};
...
//# sourceMappingURL=transition-base.js.map